...
## License
This project is released under the **MIT License**, in line with [SAFE’s open-source ethos](safe.global). See the LICENSE file for details. 
